...
public class RecoveryCalculation {
    ...
    {
        double bd = BubbleDiameter();
        double dblVolBubble = 4 / 3 * pi * Math.Pow( bd / 2, 3);
    ...
    private void CalculateEnergyDissipation()
    {
        ...
        double dblEMean = dblSpPower / dblTotalDens;
